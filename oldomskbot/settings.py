...
pastefile = 'text.txt' #File for textgen.
...
chipcom = ["/etc/init.d/tor", 'restart'] # ip change (tor restart) command.
redirlim = 1 #REDIR rec limit for tor (ip change) ocr. Default 10.
